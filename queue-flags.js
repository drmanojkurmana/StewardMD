...
(function () {
  ...
  var DEFS = {
    ...
    smd_opd_immunization: { type: "bool", def: true, query: "qimmun", desc: "OPD immunisation capture: record a vaccination with a code from the NDHM IG's own value set (functions/_vaccines.js), which is what makes ABDM's ImmunizationRecord HI type servable. def:true because it only appears inside the OPD EMR surface, which is itself PUBLIC-RELEASE-GATE def:false - this is the kill switch, not the gate. Opt out with localStorage smd_opd_immunization=0." },
