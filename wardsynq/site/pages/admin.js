...
(function () {
  ...
  WSQ.page("admin", { render: function (c) {
    ...
    if (["seed", "maik", "security", "health", "export", "fhir", "integrations", "bugs", "hrAttendance", "hrCredentials", "hrTraining", "patientComms", "onlineBooking", "patientFeedback"].indexOf(tab) >= 0 && !c.isWardsynq()) tab = "hospital";
