...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "StewardmdCapacitorConnectBrowser", path: "../../../local-plugins/capacitor-connect-browser"),
    ...
    targets: [
        .target(
            ...
            dependencies: [
                ...
                .product(name: "StewardmdCapacitorConnectBrowser", package: "StewardmdCapacitorConnectBrowser"),
