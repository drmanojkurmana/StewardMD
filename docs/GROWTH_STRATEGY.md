...
2. **Founding-Doctor offer (land grab + urgency).** First **🔧 5,000** verified doctors: **Pro at ₹399/mo locked 12 months** (or Ultimate ₹999). Public countdown ("2,140 of 5,000 founding seats left"). Uses the built coupon/entitlement system. Creates urgency and a loyal early cohort that seeds word-of-mouth.
