...
- **iOS (iPhone 17 Pro, on-device):** ARKit + LiDAR + SceneDepth verified; metric depth streams
  from the LiDAR sensor; Developer Settings show ARKit/LiDAR/SceneDepth = yes.
