...
export function quotaPacks(env) {
  ...
  return {
    ...
    "scribe.50": pack({ key: "scribe.50", feature: "scribe", units: 50, amount: P("PACK_SCRIBE_50", 99900), label: "50 MaiK Voice Scribe consults", product: "in.stewardmd.scribe.50" }),
    "scribe.250": pack({ key: "scribe.250", feature: "scribe", units: 250, amount: P("PACK_SCRIBE_250", 399900), label: "250 MaiK Voice Scribe consults", product: "in.stewardmd.scribe.250", popular: true }),
