...
INSERT OR IGNORE INTO sources (id, name, workspace, type, homepage, guideline_page, rss_url, parser_type, priority, enabled, created_ts) VALUES
  ...
  ('ema',   'European Medicines Agency',              'internal_medicine', 'drug_approval','https://www.ema.europa.eu', 'https://www.ema.europa.eu/en/news', '', 'head', 100, 0, strftime('%s','now')*1000),
  ('cdsco', 'CDSCO (India)',                          'internal_medicine', 'drug_approval','https://cdsco.gov.in', 'https://cdsco.gov.in/opencms/opencms/en/Notifications/Public-Notices/', '', 'head', 100, 0, strftime('%s','now')*1000),
