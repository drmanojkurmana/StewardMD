...
export const TEMPLATES = {
  dops: { id: "dops", scaleMin: 0, scaleMax: 5, logbookMax: 10, requireDiscussed: false, appliesTo: "procedure", source: "nmc_curriculum",
  ...
  wpba_shift: { id: "wpba_shift", scaleMin: 0, scaleMax: 5, logbookMax: 15, requireDiscussed: false, appliesTo: "period", source: "nmc_curriculum",
  ...
  wpba_clinical: { id: "wpba_clinical", scaleMin: 0, scaleMax: 5, logbookMax: 5, requireDiscussed: false, appliesTo: "clinical", source: "nmc_curriculum",
  ...
  appraisal: { id: "appraisal", scaleMin: 1, scaleMax: 9, logbookMax: 0, requireDiscussed: true, appliesTo: "period", source: "nmc_curriculum",
  ...
  academic_activity: { id: "academic_activity", scaleMin: 0, scaleMax: 5, logbookMax: 0, requireDiscussed: true, appliesTo: "academic", source: "institution",
            criteria: [{ key: "content" }, { key: "appraisal" }, { key: "delivery" }, { key: "discussion" }, { key: "preparation" }] },
  thesis_review: { id: "thesis_review", scaleMin: 0, scaleMax: 5, logbookMax: 0, requireDiscussed: true, appliesTo: "research", source: "institution",
