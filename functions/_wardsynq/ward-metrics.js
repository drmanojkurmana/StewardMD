...
function summariseWard(input) {
  ...
  const stays = (i.encounters || []).filter((e) => e && (e.class === IPD || e.class === "ED" || e.class === "ICU" || e.class === "SURGERY" || e.class === "PACU" || e.class === "MATERNITY" || e.class === "PEDIATRICS" || e.class === "NICU") && e.status === OPEN_ENC)
