...
export const ROLE_CAPS = {
  ...
  doctor: [C.QUEUE_VIEW, C.QUEUE_ADD, C.QUEUE_STATUS, C.QUEUE_PRIORITY, C.QUEUE_ASSIGN, C.QUEUE_REORDER,
           ...
           C.ORDER_READ, C.INCIDENT_REPORT, C.DEPT_REQUEST],
  ...
  pharmacy: [C.QUEUE_VIEW, C.ORDER_READ, C.ORDER_DISPENSE, C.ORDER_VERIFY, C.DEPT_REQUEST],
  ...
  radiologist: [C.QUEUE_VIEW, C.EMR_VIEW, C.LAB_RESULT, C.DEPT_REQUEST],
