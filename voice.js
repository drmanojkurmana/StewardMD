...
(function () {
  ...
  function wireModelSettings(container) {
    ...
    function renderModels() {
      ...
      var tier = voiceTier();
      var activeKeys = TIER_MODELS[tier] || [];
      var placed = {}, blocks = VOICE_GROUPS.map(function (g) {
        var keys = g.keys.filter(function (k) { return MODEL_META[k]; });
      ...
      var rest = Object.keys(MODEL_META).filter(function (k) { return !placed[k] && tiersUsing(k).length; });
