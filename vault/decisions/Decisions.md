...
- URR = (pre - post) / pre x 100, one decimal, computed on read with inputs shown; missing input, different units or a
  non-positive pre urea is "not computable", never 0. Citation: Lowrie and Lew, Am J Kidney Dis 1990;15:458-82; NKF KDOQI
  haemodialysis adequacy 2015 update. Kt/V not built (owner O12).
