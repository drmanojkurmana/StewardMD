...
- **Phase 2 (evidence RAG + Gemini report + educational features): on branch `claude/sknx-phase2`** (this work). Merged via PR after review.
- **Phase 3 (clinician-confirmed Rx): planned**, built OFF behind `smd_sknx_rx`, blocked on R1 clinical sign-off before the flag can ever flip.
