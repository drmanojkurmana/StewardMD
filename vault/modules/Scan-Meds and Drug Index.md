...
### Open-source coverage audit (2026-09-25, codex/ddi-coverage-audit)
- Includes 3,583 names across runtime, formulary and offline index. 2,840 names have no active browser rule participation; 73 browser-eligible rules out of 330 source rules. Counts are names, not unique ingredients or clinical sensitivity.
- Added semaglutide/other-GLP-1 and semaglutide/tirzepatide/insulin-secretagogue label rules. Overlapping GLP-1 findings preserve both sources in one card. New per-ingredient no-rule warnings distinguish recognition from coverage.
