...
(function () {
  ...
  function injectCSS(){
    ...
    var css=[
      ...
      ".mc-grid{display:grid;grid-template-columns:minmax(0,1fr);gap:9px}",
      "@media(min-width:720px){.mc-grid{grid-template-columns:minmax(0,1fr) minmax(0,1fr)}}",
      ...
      ".mc-inputs{display:grid;grid-template-columns:minmax(0,1fr);gap:10px;margin:12px 0}",
      "@media(min-width:560px){.mc-inputs{grid-template-columns:minmax(0,1fr) minmax(0,1fr)}}",
