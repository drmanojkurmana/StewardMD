...
PACKS.push({
  ...
  requirements: [
    req({ id: "gm_research_methodology_6m", kind: "certification", label: "Research Methodology course — within six months of the batch commencing",
          target: 1, dueByMonths: 6, requiresEvidence: true, match: { subtype: "research_methodology" },
          clause: "K. Course in Research Methodology",
          quote: "All postgraduate students shall complete an online course in Research Methodology within six months of the commencement of the batch and generate the online certificate on successful completion of the course.",
          note: "STRICTER than PGMER-2023 5.2(xi)(a), which says 'first year'. Both are shown; the module never silently replaces the regulation's deadline with the curriculum's." }),
    ...
    req({ id: "gm_exam_conference_presentations", kind: "research", label: "At least two presentations at a national-level conference", target: 2,
          mandatoryForExam: true, match: { subtype: "conference_paper" },
          clause: "Summative assessment — essential pre-requisites",
          quote: "At least two presentations at national level conference. One research paper should be published / accepted in an indexed journal. (It is suggested that the local or University Review committee assess the work sent for publication).",
          note: "EXCEEDS PGMER-2023 5.2(x), which requires one poster OR one paper read OR one first-author publication. Both are evaluated and reported separately." }),
    req({ id: "gm_exam_indexed_publication", kind: "research", label: "One research paper published / accepted in an indexed journal", target: 1,
          mandatoryForExam: true, match: { subtype: "publication" },
          clause: "Summative assessment — essential pre-requisites",
          quote: "At least two presentations at national level conference. One research paper should be published / accepted in an indexed journal. (It is suggested that the local or University Review committee assess the work sent for publication)." }),
    req({ id: "gm_exam_logbook_submitted", kind: "meta", label: "Log book of work done submitted, incl. rotation postings, departmental presentations and internal assessment reports", target: 1,
          mandatoryForExam: true, engine: "report:portfolio",
          clause: "Summative assessment — essential pre-requisites",
          quote: "Log book of work done during the training period including rotation postings, departmental presentations, and internal assessment reports should be submitted." }),
...
PACKS.push({
  ...
  requirements: [
    req({ id: "og_teaching_methods", kind: "academic", label: "Lectures, seminars, symposia, inter/intra-departmental meetings, journal club",
          ...
          quote: "Lectures, seminars, symposia, Inter- and intra- departmental meetings (clinic-pathological, Radio-diagnosis, Radiotherapy, Anaesthesia, Pediatrics/Neonatology), maternal morbidity/mortality meetings and journal club. Records of these are to be maintained by the department.",
          note: "The MS OBGY PDF prints 'clinic-pathological'. Quoted as printed rather than silently corrected to 'clinico-' — a quotation is evidence, not a transcription to be tidied." }),
...
PACKS.push({
  ...
  requirements: [
    req({ id: "pd_research_methodology_6m", kind: "certification", label: "Research Methodology course — an NMC recognized course, within six months of the batch commencing",
          target: 1, dueByMonths: 6, requiresEvidence: true, match: { subtype: "research_methodology" },
          clause: "K. Course in Research Methodology",
          quote: "All postgraduate students shall complete an NMC recognized course in Research Methodology within six months of the commencement of the batch and generate the online certificate on successful completion of the course.",
          note: "Paediatrics says an NMC RECOGNIZED course where the other 2022-revised curricula say an ONLINE course. Quoted as printed." }),
    req({ id: "pd_exam_dissemination", kind: "research",
          label: "At least one presentation at a national/state level conference — or, if not presented at national level, one paper published/accepted in an indexed journal",
          target: 1, mandatoryForExam: true,
          anyOf: [{ subtype: "conference_paper" }, { subtype: "publication", indexed: true }],
          match: { subtype: "conference_paper" },
          clause: "Summative assessment — essential pre-requisites",
          quote: "At least one if not two presentation(s) at national/state level conference. If not presented at national level, alternatively, one research paper should be published / accepted in an indexed journal. (It is suggested that the local or University Review committee assess the work sent for publication).",
          note: "The Paediatrics wording differs materially from the other 2022-revised curricula: the floor is ONE (not two), STATE level counts, and the publication is an ALTERNATIVE, not an additional requirement. Evaluated as a real OR." }),
    req({ id: "pd_exam_logbook_submitted", kind: "meta", label: "Log book of work done submitted, incl. rotation postings, departmental presentations and internal assessment reports", target: 1,
          mandatoryForExam: true, engine: "report:portfolio",
          clause: "Summative assessment — essential pre-requisites",
          quote: "Log book of work done during the training period including rotation postings, departmental presentations, and internal assessment reports should be submitted." }),
...
PACKS.push({
  ...
  requirements: [
    req({ id: "or_research_methodology_6m", kind: "certification", label: "Research Methodology course — within six months of the batch commencing",
          target: 1, dueByMonths: 6, requiresEvidence: true, match: { subtype: "research_methodology" },
          clause: "K. Course in Research Methodology",
          quote: "All postgraduate students shall complete an online course in Research Methodology within six months of the commencement of the batch and generate the online certificate on successful completion of the course.",
          note: "STRICTER than PGMER-2023 5.2(xi)(a), which says 'first year'. Both are shown; the module never silently replaces the regulation's deadline with the curriculum's." }),
    ...
    req({ id: "or_cme", kind: "academic", label: "Attendance at scientific meetings / CME programmes", target: 2, per: "course",
          match: { academicType: "cme_conference" }, clause: "Assessment — Quarterly assessment",
          quote: "Attendance at Scientific meetings, CME programmes (at least 02 each)" }),
    req({ id: "or_exam_conference_presentations", kind: "research", label: "At least two presentations at a national-level conference", target: 2,
          mandatoryForExam: true, match: { subtype: "conference_paper" },
          clause: "Summative assessment — essential pre-requisites",
          quote: "At least two presentations at national level conference. One research paper should be published / accepted in an indexed journal. (It is suggested that the local or University Review committee assess the work sent for publication).",
          note: "EXCEEDS PGMER-2023 5.2(x), which requires one poster OR one paper read OR one first-author publication. Both are evaluated and reported separately." }),
    req({ id: "or_exam_indexed_publication", kind: "research", label: "One research paper published / accepted in an indexed journal", target: 1,
          mandatoryForExam: true, match: { subtype: "publication" },
          clause: "Summative assessment — essential pre-requisites",
          quote: "At least two presentations at national level conference. One research paper should be published / accepted in an indexed journal. (It is suggested that the local or University Review committee assess the work sent for publication)." }),
    req({ id: "or_exam_logbook_submitted", kind: "meta", label: "Log book of work done submitted, incl. rotation postings, departmental presentations and internal assessment reports", target: 1,
          mandatoryForExam: true, engine: "report:portfolio",
          clause: "Summative assessment — essential pre-requisites",
          quote: "Log book of work done during the training period including rotation postings, departmental presentations, and internal assessment reports should be submitted." }),
...
PACKS.push({
  ...
  requirements: [
    ...
    req({ id: "rd_ug_teaching", kind: "academic", label: "Teaching and training of undergraduates and interns",
        match: { academicType: "ug_teaching" }, clause: "Training components — 6",
        quote: "The postgraduate students shall be required to participate in the teaching and training program of undergraduate students and interns.",
        note: "MD Radiodiagnosis writes 'program'; the other 2019-era guidelines write 'programme'. Quoted as printed." }),
...
PACKS.push({
  ...
  requirements: [
    req({ id: "pa_research_methodology_6m", kind: "certification", label: "Research Methodology course — within six months of the batch commencing",
          target: 1, dueByMonths: 6, requiresEvidence: true, match: { subtype: "research_methodology" },
          clause: "K. Course in Research Methodology",
          quote: "All postgraduate students shall complete an online course in Research Methodology within six months of the commencement of the batch and generate the online certificate on successful completion of the course.",
          note: "STRICTER than PGMER-2023 5.2(xi)(a), which says 'first year'. Both are shown; the module never silently replaces the regulation's deadline with the curriculum's." }),
    req({ id: "pa_exam_conference_presentations", kind: "research", label: "At least two presentations at a state or national level conference", target: 2,
          mandatoryForExam: true, match: { subtype: "conference_paper" },
          clause: "Summative assessment — essential pre-requisites",
          quote: "At least two presentations at state/national level conference. One paper (thesis or non-thesis related work) should be published /accepted/publication draft in an indexed journal.",
          note: "Pathology accepts STATE level, where General Medicine and Orthopaedics say national." }),
    req({ id: "pa_exam_indexed_publication", kind: "research", label: "One paper (thesis or non-thesis work) published, accepted OR in publication draft in an indexed journal", target: 1,
          mandatoryForExam: true, match: { subtype: "publication" },
          clause: "Summative assessment — essential pre-requisites",
          quote: "At least two presentations at state/national level conference. One paper (thesis or non-thesis related work) should be published /accepted/publication draft in an indexed journal.",
          note: "A publication DRAFT satisfies this in Pathology; General Medicine and Orthopaedics require published/accepted." }),
    req({ id: "pa_exam_logbook_submitted", kind: "meta", label: "Log book of work done submitted, incl. rotation postings, departmental presentations and internal assessment reports", target: 1,
          mandatoryForExam: true, engine: "report:portfolio",
          clause: "Summative assessment — essential pre-requisites",
          quote: "Log book of work done during the training period including rotation postings, departmental presentations, and internal assessment reports should be submitted." }),
    ...
    // pa_cpc REMOVED 2026-08-27: it cited "…clinico-pathological conferences…" to "Teaching and
    // learning methods", and that phrase is not in the MD Pathology (revised 2022) PDF at all — the
    // only "clinico" in that document is an unrelated sentence about correlation. It was a fabricated
    // quotation and the provenance test now refuses it. PGMER-2023 5.2(x) already covers CPCs for
    // every specialty, so nothing is lost by deleting it rather than inventing a replacement.
    req({ id: "pa_lab_reporting", kind: "procedure", label: "Laboratory reporting workload",
          match: { roles: ["observed", "assisted", "performed_supervised", "performed_independent"] },
          clause: "Teaching and learning methods",
          quote: "Laboratory work / Bedside clinics … should be coordinated and guided by faculty from the department." })
  ],
  procedures: [],
...
const EM_PROCEDURES = [
  ...
  // 17c-24. R1 finding I1: the first cut of this list stopped at 22e, silently dropping 17 of the
  // NMC's stated minima (including NG tube insertion (100) and imaging/lab interpretation (100)) —
  // about a fifth of the requirement — from a checklist that looked complete. Verified against
  // pglog-sources/emerg.txt; test/pglog-curriculum.test.mjs now checks every number against it.
  ["em_lateral_canthotomy", "Lateral Canthotomy", 1],
  ["em_iop", "IOP measurement", 5],
  ["em_delivery", "Delivery", 10],
  ["em_speculum", "Speculum examination", 10],
  ["em_perimortem_caesarean", "Perimortem Caesarean section", null],
  ["em_paraphimosis", "Reducing paraphimosis", 2],
  ["em_ng_tube", "Nasogastric tube insertion", 100],
  ["em_abscess", "Incision and drainage of abscess", 20],
  ["em_nerve_block", "Nerve blocks", 20],
  ["em_testis_detorsion", "Detorsion of torsion of testis", 2],
  ["em_abdo_renal_pocus", "Abdominal and Renal POCUS", 50],
  ["em_soft_tissue_us", "Soft tissue and skin ultrasound", 25],
  ["em_joint_fracture_us", "Joint and fracture assessment", 25],
  ["em_arrest_pocus", "Cardiac arrest POCUS/TEE", 5],
  ["em_procedural_guidance_us", "Procedural guidance", 50],
  ["em_ocular_us", "Ocular ultrasound", 25],
  ["em_investigation_interpretation", "Interpretation of laboratory investigations/plain X-rays/CT/MRI", 100],
...
PACKS.push({
  ...
  requirements: [
    ...
    req({ id: "em_academic_journal_club", kind: "academic", label: "Journal club presentation",
          ...
          quote: "Journal Club Presentation performance",
          note: "Printed as a bullet under: Academic activities (consolidated –within department/peripheral posting/outside department/outside institution)" }),
