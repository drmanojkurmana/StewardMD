...
(function () {
  ...
  var F = [
    ...
    { id: "pedalEdema", label: "Bilateral pedal / lower-limb oedema", cid: "legSwellingBilateral", group: "Signs", sys: "General", ws: [IM], syn: ["pedal edema", "pedal oedema", "peripheral oedema", "peripheral edema", "lower limb swelling", "lower limb oedema", "lower limb edema", "b/l lower limb swelling", "bilateral lower limb swelling", "lower limb both swelling", "leg swelling", "leg oedema", "both leg swelling", "both legs swollen", "bilateral leg swelling", "swollen legs", "swelling of legs", "swelling of both legs", "feet swelling", "swollen feet", "ankle swelling", "ankle oedema", "b/l pedal edema", "bipedal edema", "dependent oedema"] },
    { id: "anasarca", label: "Generalised oedema / anasarca", cid: "legSwellingBilateral", group: "Signs", sys: "General", ws: [IM], syn: ["anasarca", "generalised oedema", "generalized edema", "generalised swelling", "whole body swelling", "swelling all over", "gross edema", "total body swelling"] },
    ...
    { id: "periorbitalEdema", label: "Facial / periorbital puffiness", cid: "facialSwelling", group: "Signs", sys: "Renal-GU", ws: [IM], syn: ["periorbital edema", "periorbital oedema", "facial puffiness", "puffy face", "puffy eyes", "facial swelling", "puffy eyelids", "swelling around eyes", "morning facial swelling", "periorbital puffiness"] },
