...
(function () {
  ...
  function injectCSS() {
    ...
    s.textContent = [
      ...
      ".smd-grid2{display:grid;grid-template-columns:minmax(0,1fr) minmax(0,1fr);gap:10px}",
      ...
      ".smd-badges{display:grid;grid-template-columns:minmax(0,1fr) minmax(0,1fr);gap:10px}",
      ...
      ".smd-cal{display:grid;grid-template-columns:repeat(10,minmax(0,1fr));gap:5px}",
