...
/* Both sides bumped this. main carries the ECG-atlas route (ecgatlas1) and the two-phase boot
 * splash (splashv2h); this change adds the OTA error-leak fix (otaleak). The key is one opaque
 * string, so keeping either alone leaves the other deploy's clients on a stale cache. Carry all
 * three markers. */
var CACHE = "stewardmd-nb-consult1-onco6-atlas2-maikllm1-wr1-clinix29-ccsguard-surgx12-maikart1-pglog5-ack1-pgl1-vclaim1-fcux1-proevt1-b25-splashv2h-ecgatlas1-otaleak";
