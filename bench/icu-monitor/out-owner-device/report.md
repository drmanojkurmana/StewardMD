...
Generated 2026-09-14T21:11:09.755Z. Local extraction only (Apple Vision on macOS + icu-monitor-parser.js). **Gemini calls: 0** (not part of this benchmark; the app's on-tap fallback is counted separately). Network calls: 0.
...
Silent guesses 0 · incomplete evidence 0 · RETAKE_PHOTO 1 · DEGRADED 2 · avg Vision full 199.3 ms + crop 123.6 ms · parse 3.2 ms · boxes 31.7 (+7.7 from crop) · colour used in 21

| field | visible | correct | wrong | review | missed | exact % | precision % | needs-review % | silent-guess % | safe % |
|---|---|---|---|---|---|---|---|---|---|---|
| hr | 13 | 6 | 0 | 8 | 1 | 46.2 | 100 | 50 | 0 | 56.3 |
...
- **owner-aa0cb94d** [real] (ge-dash, published-photo+low-resolution+dual-pressure+alarm-list, quality OK): hr review (exp 84, sug 84: confidence 0.77 below 0.8); spo2 review (exp 97, sug 60: two candidates too close (60 vs 84)); rr review (exp 24, sug 60: two candidates too close (60 vs 43)); pvc review (exp 0, sug 0: the value was not read identically by both OCR passes); temp review (exp 36.5, sug 40: the value was not read identically by both OCR passes); art missed (exp {"sbp":141,"dbp":43,"map":70}); nibp missed (exp {"sbp":113,"dbp":60,"map":81})
