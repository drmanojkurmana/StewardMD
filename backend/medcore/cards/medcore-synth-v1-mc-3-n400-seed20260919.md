...
|---|---|
| encounters | 400 |
| prediction points | 5097 (grid 4 h) |
| train / val / test | 3081 / 1024 / 992 |
| event rate | train 3.08%, val 4.69%, test 3.63% |
| excluded from the risk set | 603 {"EXCLUDED_FROM_RISK_SET":603} |
| injected prevalent cases | 40 (must be excluded, HAZ-ML-02) |
| injected rescued cases | 34 (the treatment paradox, labelled negative by construction) |
| frequency bias | off |
...
Gates: missedEventsReduced25 FAIL, ece PASS, calibrationSlope PASS, eventsPerVariable PASS, noSubgroupCollapse PASS, selectiveRiskFalls PASS, beatsFrequencyProbe PASS.
