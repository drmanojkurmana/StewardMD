...
(function () {
    ...
    if (isPooled(scope)) {
      ...
      rows.forEach(function (r) {
        ...
        out.push({ org: r.org, pheno: r.pheno, n: r.n, k: 1, cells: r.cells, rows: [r], row: r, lowN: r.flags.indexOf("lowN") >= 0, noN: r.flags.indexOf("noN") >= 0, derived: r.derived, how: r.how, as: r.as, q: r.q, notes: r.notes,
          measure: r.measure, cohort: r.cohort, note: r.note, table: r.table, page: r.page });
      });
    }
  ...
  function cell(scope, spec, set, org, pheno, drug) {
    ...
    o.rows.forEach(function (r) { var rc = r.cells[drug]; if (rc) parts.push({ src: r.src, s: rc.s, act: rc.act, why: rc.why, nt: rc.nt, n: r.n, lowN: r.n != null && r.n < R.M39_MIN, derived: r.derived, page: r.page, note: r.notes && r.notes[drug] }); });
