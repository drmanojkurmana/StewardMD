...
_LINES = {
    "en": {
        ...
        "still_there": "Are you still there? Please answer, or I can call back later.",
        "ack": "Thank you.",
    ...
    "te": {
        ...
        "still_there": "మీరు ఇంకా లైన్‌లో ఉన్నారా? దయచేసి చెప్పండి, లేదా నేను తర్వాత మళ్ళీ కాల్ చేస్తాను.",
        "ack": "ధన్యవాదాలు.",
