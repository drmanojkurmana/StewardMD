...
try {
  ...
  ok(await ev(`var o=document.querySelectorAll('#aType option'); return o.length>=5 && [].slice.call(o).filter(function(x){return x.disabled;}).length>=4;`) === true, "type picker shows FHIR active + 4 disabled 'coming soon' types");
