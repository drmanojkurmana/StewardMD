...
test("role mapping: every operational role resolves to exactly the grant its capabilities imply", () => {
  ...
  assert.deepEqual(write("supervisor"), ["Patient", "Encounter", "Appointment", "PatientLink", "PrescriptionTransmission", "AdmissionRequest", "ResourceBooking", "Blackout", "RelatedPerson", "PrivacyAcknowledgement", "TransferRequest", "TheatreSession", "DiagnosticVisit", "IncidentReport", "AdverseDrugReaction", "Indent", "IndentReceipt", "JobCard", "EmergencyStockOut", "IndentDecision", "HousekeepingTask", "DischargeMilestone", "TransferCentreRequest"]);
  ...
  assert.deepEqual(write("reception"), ["Patient", "Encounter", "Appointment", "PatientLink", "PrescriptionTransmission", "AdmissionRequest", "ResourceBooking", "Blackout", "RelatedPerson", "PrivacyAcknowledgement", "TransferRequest", "TheatreSession", "DiagnosticVisit", "DischargeMilestone", "TransferCentreRequest"]);
  ...
  assert.deepEqual(write("safety_officer"), ["IncidentReport", "AdverseDrugReaction", "QualityAuditTemplate", "QualityAudit", "MockDrill"]);
...
test("OPD roles at the door: doctor writes and signs, nurse records vitals and nothing else, reception reads only, pharmacy sees orders only, hr is refused", async () => {
  ...
  assert.deepEqual(desk.descriptor.actor.writable, ["Patient", "Encounter", "Appointment", "PatientLink", "PrescriptionTransmission", "AdmissionRequest", "ResourceBooking", "Blackout", "RelatedPerson", "PrivacyAcknowledgement", "TransferRequest", "TheatreSession", "DiagnosticVisit", "DischargeMilestone", "TransferCentreRequest"]);
