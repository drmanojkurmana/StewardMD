...
test("role mapping: every operational role resolves to exactly the grant its capabilities imply", () => {
  ...
  assert.deepEqual(write("supervisor"), ["Patient", "Encounter", "Appointment", "PatientLink", "PrescriptionTransmission", "AdmissionRequest", "ResourceBooking", "Blackout", "RelatedPerson", "PrivacyAcknowledgement", "TransferRequest", "TheatreSession", "DiagnosticVisit", "IncidentReport", "AdverseDrugReaction", "Indent", "IndentReceipt", "JobCard", "EmergencyStockOut", "IndentDecision", "HousekeepingTask"]);
  ...
  assert.deepEqual(write("reception"), ["Patient", "Encounter", "Appointment", "PatientLink", "PrescriptionTransmission", "AdmissionRequest", "ResourceBooking", "Blackout", "RelatedPerson", "PrivacyAcknowledgement", "TransferRequest", "TheatreSession", "DiagnosticVisit"]);
  ...
  assert.deepEqual(write("pharmacy"), ["MedicationVerification", "MedicationDispense", "StockMovement", "PurchaseOrder", "Vendor", "Verification", "Indent", "IndentReceipt", "JobCard", "EmergencyStockOut"]);
...
test("OPD roles at the door: doctor writes and signs, nurse records vitals and nothing else, reception reads only, pharmacy sees orders only, hr is refused", async () => {
  ...
  assert.deepEqual(desk.descriptor.actor.writable, ["Patient", "Encounter", "Appointment", "PatientLink", "PrescriptionTransmission", "AdmissionRequest", "ResourceBooking", "Blackout", "RelatedPerson", "PrivacyAcknowledgement", "TransferRequest", "TheatreSession", "DiagnosticVisit"]);
  ...
  assert.deepEqual(pharm.descriptor.actor.readable,
    ["MedicationOrder", "ServiceRequest", "AllergyIntolerance", "Observation", "Condition", "MedicationAdministration", "CriticalResultLoop", "MedicationVerification", "MedicationDispense", "StockMovement", "PurchaseOrder", "Vendor", "Verification",
      ...
      "Indent", "IndentReceipt", "JobCard", "EmergencyStockOut", "IndentDecision", "IndentClosure", "StoreItem", "StoreLocation", "Asset", "AssetEvent", "JobCardEvent"]);
