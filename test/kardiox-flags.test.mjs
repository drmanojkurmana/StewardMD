...
/* Master default history: OFF (private beta) -> ON for every user (owner, 2026-08-26) -> OFF again
 * (owner, 2026-09-25): KardiQ X is a code-gated beta, unlocked per device with a StewardMD access code
 * (SMD_XACCESS sets smd_kardiox=1 on unlock). The model is still unvalidated and regulatory-pending. */
ok("flags: master default OFF, code-gated beta (owner decision 2026-09-25)", F.get("smd_kardiox") === false && F.bool("smd_kardiox") === false);
