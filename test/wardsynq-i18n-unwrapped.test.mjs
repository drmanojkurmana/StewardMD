...
const SITE_FILES = ["wardsynq/site/shell.js", "wardsynq/site/bug-reporter.js", "wardsynq/ui/wardsynq-app.js",
  ...["abdm", "accounts", "admin", "audit", "engage", "governance", "group", "hr", "lab-analysers", "maik", "patients", "portal-access", "registers", "rota", "security", "stores", "assets", "bloodbank", "support", "quality"].map((p) => "wardsynq/site/pages/" + p + ".js")];
