...
public class SpeechRecognition: CAPPlugin, CAPBridgedPlugin {
    ...
    // SPM registration (replaces the old Plugin.m CAP_PLUGIN macro so this builds as a
    // pure-Swift SPM target — vendored under local-plugins for StewardMD's SPM iOS project).
