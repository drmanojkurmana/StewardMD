...
- In `agent` mode the allowlist is enforced natively on main-frame navigations. This is policy outside the AI: no JavaScript, and no planner, can widen it.
